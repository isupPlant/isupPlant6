...
#维修工单
-keep class * extends BaseListDataRecyclerViewAdapter

#plugin
-keep class com.supcon.mes.proxy.internal.VAInstrumentation { *; }
-keep class com.supcon.mes.proxy.internal.PluginContentResolver { *; }
